...
const { User, attendanceGroups, attendanceRecorded, meeting, attendance } = require('../../models/index');
const { userGroups, groupAttendanceCount } = require('../../src/controllers/getUserGroups');
